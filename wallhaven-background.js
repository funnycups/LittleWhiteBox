...
function unbindMessageHandlers() {
    if (messageHandlers.messageReceived) {
        eventSource.off(event_types.MESSAGE_RECEIVED, messageHandlers.messageReceived);
    }
    if (messageHandlers.messageSwiped && event_types.MESSAGE_SWIPED) {
        eventSource.off(event_types.MESSAGE_SWIPED, messageHandlers.messageSwiped);
    }
    if (messageHandlers.messageEdited && event_types.MESSAGE_EDITED) {
        eventSource.off(event_types.MESSAGE_EDITED, messageHandlers.messageEdited);
    }
    if (messageHandlers.messageUpdated && event_types.MESSAGE_UPDATED) {
        eventSource.off(event_types.MESSAGE_UPDATED, messageHandlers.messageUpdated);
    }
